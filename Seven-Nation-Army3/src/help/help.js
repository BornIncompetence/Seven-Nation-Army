    ...
    return (
      <Container>
        ...
        <Container centered id={'.pdfViewer'}>
          <nav>
            <Button
              style={{ marginBottom: '5pt', marginRight: '5pt' }}
              onClick={this.goToPrevPage}
            >
              Prev
            </Button>
            <Button style={{ marginBottom: '5pt' }} onClick={this.goToNextPage}>
              Next
            </Button>
          </nav>

          <div style={{ width: 600 }}>
            <Document file={manual} onLoadSuccess={this.onDocumentLoadSuccess}>
